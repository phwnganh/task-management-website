...
//     // Thiết lập interval để kiểm tra định kỳ (ví dụ: mỗi 24 giờ)
//     const intervalId = setInterval(checkAndHandleExpiredProjects, 24 * 60 * 60 * 1000); // 24 giờ
...
//         recipient_id: userId,
//         initiator_id: "system",
//         message: `The project ${projectTitle} has been automatically deleted from the system.`,
//         status: "Unread",
//         created_at: dayjs().toISOString(),
//       };
//       try {
//         await apiCreateNotifications(notificationData);
//         await apiDeleteProjects(projectId);
//         setProjects((prevProjects) =>
//           prevProjects.filter((p) => p.id !== projectId)
//         );
//         notification.success({
//           message: "Notification sent and delete project successfully!",
//           placement: "bottomRight",
//         });
//       } catch (error) {
//         notification.error({
...
//     if (daysRemaining <= 0) {
//       notification.error({
//         message: `The ${projectTitle} can no longer be restored.`,
//         placement: "bottomRight",
//       });
//       return;
//     }
...
//         // Kiểm tra nếu là "1 day remaining" thì áp dụng màu vàng
//         const textColor =
